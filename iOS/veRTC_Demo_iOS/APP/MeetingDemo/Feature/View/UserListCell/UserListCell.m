...
- (BaseButton *)enableAudioBtn {
    if (!_enableAudioBtn) {
        ...
        [_enableAudioBtn bingImage:[UIImage imageNamed:@"meeting_par_mic" bundleName:HomeBundleName] status:ButtonStatusNone];
        [_enableAudioBtn bingImage:[UIImage imageNamed:@"meeting_par_mic_s" bundleName:HomeBundleName] status:ButtonStatusActive];
        [_enableAudioBtn bingImage:[UIImage imageNamed:@"meeting_par_mic_i" bundleName:HomeBundleName] status:ButtonStatusIng];
...
- (BaseButton *)enableVideoBtn {
    if (!_enableVideoBtn) {
        ...
        [_enableVideoBtn bingImage:[UIImage imageNamed:@"meeting_par_camera" bundleName:HomeBundleName] status:ButtonStatusNone];
        [_enableVideoBtn bingImage:[UIImage imageNamed:@"meeting_par_camera_s" bundleName:HomeBundleName] status:ButtonStatusActive];
...
- (UIImageView *)screenImageView {
    if (!_screenImageView) {
        ...
        _screenImageView.image = [UIImage imageNamed:@"meeting_par_screen" bundleName:HomeBundleName];
    }
