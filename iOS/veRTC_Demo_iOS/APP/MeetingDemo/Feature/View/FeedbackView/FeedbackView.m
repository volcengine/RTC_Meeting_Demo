...
- (void)initFeedBackUIComponents {
    ...
    [self.feedbackGoodBtn setImage:[UIImage imageNamed:@"meeting_feed_good" bundleName:HomeBundleName] forState:UIControlStateNormal];
    ...
    [self.feedbackBadBtn setImage:[UIImage imageNamed:@"meeting_feed_bad" bundleName:HomeBundleName] forState:UIControlStateNormal];
    ...
    [self.feedbackCloseBtn setImage:[UIImage imageNamed:@"meeting_feed_cancel" bundleName:HomeBundleName] forState:UIControlStateNormal];
