...
- (void)addScreenStreamsUid:(NSString *)streamsUid {
    [[MeetingRTCManager shareRtc] subscribeScreenStream:streamsUid];
    [[MeetingRTCManager shareRtc] setupRemoteScreen:self.renderScreenView uid:streamsUid];
}

- (void)removeScreenStreamsUid:(NSString *)streamsUid {
    [[MeetingRTCManager shareRtc] unsubscribeScreen:streamsUid];
    [[MeetingRTCManager shareRtc] setupRemoteScreen:nil uid:streamsUid];
}
...
- (BaseButton *)orientationButton {
    if (!_orientationButton) {
        ...
        [_orientationButton bingImage:[UIImage imageNamed:@"meeting_room_orientation" bundleName:HomeBundleName] status:ButtonStatusNone];
        [_orientationButton bingImage:[UIImage imageNamed:@"meeting_room_orientation_v" bundleName:HomeBundleName] status:ButtonStatusActive];
    }
