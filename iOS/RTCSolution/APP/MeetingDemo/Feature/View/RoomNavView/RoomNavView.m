...
- (BaseButton *)switchCameraBtn {
    if (!_switchCameraBtn) {
        ...
        [_switchCameraBtn setImage:[UIImage imageNamed:@"meeting_room_camera" bundleName:HomeBundleName] forState:UIControlStateNormal];
...
- (BaseButton *)hangeupButton {
    if (!_hangeupButton) {
        ...
        [_hangeupButton setImage:[UIImage imageNamed:@"meeting_room_hangeup" bundleName:HomeBundleName] forState:UIControlStateNormal];
