...
- (void)meetingRTCManager:(MeetingRTCManager *_Nullable)manager
       onRoomStateChanged:(RTCJoinModel *_Nullable)joinModel;
...
- (void)rtcManager:(MeetingRTCManager *_Nonnull)rtcManager onRemoteVideoSizeChanged:(NSString *_Nullable)screenStreamsUid;
 ...
 */
- (void)setupRemoteStreamKey:(ByteRTCRemoteStreamKey *_Nullable)streamKey
                      canvas:(ByteRTCVideoCanvas *_Nullable)canvas;
