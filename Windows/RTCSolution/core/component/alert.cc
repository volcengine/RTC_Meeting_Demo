...
namespace vrd
{
		...
		: QDialog(parent)
	{
		...
		this->lbl_tip_->setStyleSheet("margin: 6px; font: 12px \"Microsoft YaHei\"; color: black;");
		...
		cancel_button->setStyleSheet("border: none; margin: 6px; font: 12px \"Microsoft YaHei\"; color: black;");
		...
		btn_ok->setFlat(true);
		btn_ok->setStyleSheet("border: none; margin: 6px; font: 12px \"Microsoft YaHei\"; color: black;");
