...
PushButtonWarp::PushButtonState PushButtonWarp::state() { return state_; }

void PushButtonWarp::paintEvent(QPaintEvent *e) { QPushButton::paintEvent(e); }
...
void PushButtonWarp::leaveEvent(QEvent *) { setState(state_); }
