...
/**
 * @brief 单独获取 Redux 中的RTC信息
 * @function mapStateToProps
 * @returns
 */
const mapRTCStateToProps = (state: AppState) => {
  return {
    rtc: state.rtcClientControl.rtc,
  };
};

const connectorRTC = connect(mapRTCStateToProps, mapDispatchToProps);

const injectRTC = (comp: React.FC<any> | React.ComponentType<any>) => {
  return connectorRTC(injectIntl(comp));
};
