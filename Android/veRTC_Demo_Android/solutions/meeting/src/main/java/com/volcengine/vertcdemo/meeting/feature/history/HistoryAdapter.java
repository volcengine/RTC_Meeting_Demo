...
public class HistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final List<MeetingRecordInfo> mMeetingRecordInfoList = new ArrayList<>();
    ...
    static class HistoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(MeetingRecordInfo info) {
            mUrl.setText(formatTime(info.createdAt));
            itemView.setOnClickListener(v -> mOnClickRecord.onClick(info.downloadUrl));
