...
public class ParticipantAdapter extends RecyclerView.Adapter<ParticipantAdapter.ParticipantViewHolder> {
    ...
    private void bindView(ParticipantViewHolder holder, MeetingUserInfo entity) {
        ...
        if (!entity.is_mic_on && MeetingDataManager.getUserVolume(entity.user_id) > AudioVideoConfig.VOLUME_MIN_THRESHOLD) {
    ...
    private void bindVolume(ParticipantViewHolder holder, MeetingUserInfo entity) {
        ...
        } else if (MeetingDataManager.getUserVolume(entity.user_id) > AudioVideoConfig.VOLUME_MIN_THRESHOLD) {
