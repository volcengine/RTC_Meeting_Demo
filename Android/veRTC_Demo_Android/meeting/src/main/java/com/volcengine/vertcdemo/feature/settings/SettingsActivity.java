package com.volcengine.vertcdemo.feature.settings;
...
import com.volcengine.vertcdemo.feature.history.HistoryActivity;
...
public class SettingsActivity extends BaseActivity {
    ...
    public void finish() {
        ...
        if (mCurrentConfigEntity != mOriginConfigEntity) {
            ...
            LinkedList<VideoStreamDescription> descriptions = new LinkedList<>();
        ...
        MeetingRTCManager.setScreenShareProfiles(videoEncoderConfig);
    }
